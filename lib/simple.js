...
/**
 * Crea un socket WhatsApp con opzioni aggiuntive.
 * @param {object} connectionOptions - Opzioni di connessione
 * @param {object} [options={}] - Opzioni aggiuntive
 * @returns {object} Il socket WhatsApp configurato
 */
export function makeWASocket(connectionOptions, options = {}) {
  // FIX: Controllo di sicurezza su global.opts per evitare il crash
  const isLegacy = global.opts && global.opts['legacy'] ? true : false;
  
  const conn = (isLegacy ? makeWALegacySocket : _makeWASocket)(connectionOptions);
