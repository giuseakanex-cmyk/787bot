...
const featureRegistry = [
  ...
  { key: 'antispam', store: 'chat', perm: PERM.ADMIN, aliases: [], name: '🛑 Antispam testuale', desc: 'Antispam per testi e link' },
  { key: 'antispamcomandi', store: 'chat', perm: PERM.ADMIN, aliases: ['antispambot'], name: '🛑 Anti-spam comandi', desc: 'Limita lo spam dei comandi bot' },
